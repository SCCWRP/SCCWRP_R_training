...
As mentioned before, we want to compare influent and effluent concentrations measured for one or more samples, for one or more storms, at different wastewater treatment plants.  The columns we care about are:

* `SITENAME`: unique identifier for the wastewater treatment plant
* `MSNAME`: identifier for different samples from a wastewater treatment plant, this is where the influent and effluent measurements are identified
* `Storm #`: identifier for storm events that occurred at a wastewater treatment plant
