...
As mentioned before, we want to compare influence and effluent concentrations measured for one or more samples, for one or more storms, at different wastewater treatment plants.  The columns we care about are:
